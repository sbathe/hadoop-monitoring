#!/usr/bin/python
"""
Requires: python module ambariclient
https://github.com/jimbobhickville/python-ambariclient

TODO:
    A lot. Need to start building this up
...
parser.add_argument("-C", action="store", dest='cluster', help="Cluster name to check",required=True)
parser.add_argument("-S", action="store", dest='service', help="Service name to check",required=True)
